...
public class RecordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        age = (EditText) findViewById(R.id.tv_time);
...
//                age.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        ...
        case R.id.note_save:
            ...
            // 获取输入内容
            Intent intent = getIntent();
            String nameContent = content.getText().toString().trim();
            String ageContent = age.getText().toString().trim();
            NotepadBean notepadBean = new NotepadBean();
            notepadBean.setId(id);
            notepadBean.setName(nameContent);
            notepadBean.setAge(ageContent);
